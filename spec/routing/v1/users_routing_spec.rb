...
RSpec.describe V1::UsersController, type: :routing do
  describe "routing" do
    ...
    it "routes to #update via PUT" do
      expect(:put => "/v1/users/1").to route_to("v1/users#update", :id => "1", format: :json)
    end

    it "routes to #update via PATCH" do
      expect(:patch => "/v1/users/1").to route_to("v1/users#update", :id => "1", format: :json)
    end

    it "routes to #destroy" do
      expect(:delete => "/v1/users/1").to route_to("v1/users#destroy", :id => "1", format: :json)
    end
